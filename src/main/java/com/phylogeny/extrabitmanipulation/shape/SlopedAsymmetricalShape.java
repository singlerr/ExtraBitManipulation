...
public abstract class SlopedAsymmetricalShape extends AsymmetricalShape {
  ...
  public boolean isPointInsideShape(BlockPos pos, int i, int j, int k) {
    ...
    return sculptHollowShape ?
        inShape && !(isPointIn2DShape(y, aInset2, cInset2, dx, dz) && !isPointOffLine(y)) : inShape;
  }
  ...
  protected abstract boolean isPointIn2DShape(float val, float semiDiameter1, float semiDiameter2,
                                              float dv1, float dv2);
