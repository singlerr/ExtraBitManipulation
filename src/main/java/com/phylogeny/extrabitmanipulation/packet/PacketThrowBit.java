    ...
    public IMessage onMessage(final PacketThrowBit message, final MessageContext ctx) {
      ...
      mainThread.addScheduledTask(new Runnable() {
        ...
        public void run() {
          ...
          boolean isBit =
              ChiselsAndBitsAPIAccess.apiInstance.getItemType(stack) == ItemType.CHISLED_BIT;
          if (!isBit) {
          ...
          entityBit.setAim(player, player.rotationPitch, player.rotationYaw,
          ...
          player.world.playSound(null, player.posX, player.posY, player.posZ,
              SoundEvents.ENTITY_SNOWBALL_THROW, SoundSource.NEUTRAL, 0.5F,
              0.4F / (player.world.rand.nextFloat() * 0.4F + 0.8F));
