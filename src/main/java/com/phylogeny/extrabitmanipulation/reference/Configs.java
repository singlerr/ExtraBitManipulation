...
public class Configs {
  ...
  public static Map<BlockState, IBitBrush> modelBlockToBitMap;
  public static Map<BlockState, IBitBrush> modelStateToBitMap;
  ...
  public static Map<Item, ConfigShapeRenderPair> itemShapeMap =
      new HashMap<Item, ConfigShapeRenderPair>();
