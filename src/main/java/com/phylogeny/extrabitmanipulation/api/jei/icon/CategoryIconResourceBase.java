...
public abstract class CategoryIconResourceBase extends CategoryIconBase {
  ...
  public CategoryIconResourceBase(int u, int v, int width, int height, int textureWidth,
                                  int textureHeight) {
    super(width, height);
  ...
  public void draw(Minecraft minecraft, int xOffset, int yOffset, int maskTop, int maskBottom,
    ...
    Gui.drawScaledCustomSizeModalRect(x, y, u, v, textureWidth, textureHeight, width, height,
