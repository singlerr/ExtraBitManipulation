...
public class GuiButtonTextured extends GuiButtonBase {
  private static final ResourceLocation BOX_CHECKED =
      new ResourceLocation(Reference.MOD_ID, "textures/guis/box_checked.png");
  private static final ResourceLocation BOX_UNCHECKED =
      new ResourceLocation(Reference.MOD_ID, "textures/guis/box_unchecked.png");
  private final ResourceLocation selectedTexture;
  private final ResourceLocation deselectedTexture;

  public GuiButtonTextured(int buttonId, int x, int y, int width, int height, String hoverText,
                           ResourceLocation selectedTexture,
                           ResourceLocation deselectedTexture, @Nullable SoundEvent boxCheck,
                           @Nullable SoundEvent boxUncheck) {
  ...
  public static GuiButtonTextured createCheckBox(int buttonId, int x, int y, int width, int height,
                                                 String hoverText) {
    return new GuiButtonTextured(buttonId, x, y, width, height, hoverText,
        BOX_CHECKED, BOX_UNCHECKED, SoundsExtraBitManipulation.boxCheck,
        SoundsExtraBitManipulation.boxUncheck);
  }
