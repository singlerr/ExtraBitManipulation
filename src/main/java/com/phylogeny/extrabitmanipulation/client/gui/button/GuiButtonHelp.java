...
public class GuiButtonHelp extends GuiButtonCustom {
  ...
  public GuiButtonHelp(int buttonId, List<GuiButton> buttonList, int x, int y, String hoverText,
                       String hoverTextSelected) {
  ...
  public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks) {
    ...
    for (int k = 0; k <= s; k++) {
      ...
      buffer.vertex(x + Math.sin(angle) * radius, y + Math.cos(angle) * radius, 0)
