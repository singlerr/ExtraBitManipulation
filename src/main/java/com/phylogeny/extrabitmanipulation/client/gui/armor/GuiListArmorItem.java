...
public class GuiListArmorItem extends GuiListChiseledArmor<ArmorItem> {
  ...
  public GuiListArmorItem(GuiChiseledArmor guiChiseledArmor, int heightIn, int topIn, int bottomIn,
                          int slotHeightIn, int offsetX, int listWidth,
                          DataChiseledArmorPiece armorPiece, int partIndex) {
    super(guiChiseledArmor, heightIn, topIn, bottomIn, slotHeightIn, offsetX, listWidth,
        armorPiece);
